...
export default function GapirishBetaAttemptPage() {
    ...
    return (
      <div>
        ...
        <div className="text-center pb-10">
          <button onClick={() => router.push('/app/gapirish-beta')} className="text-sm text-accent hover:underline font-semibold">
