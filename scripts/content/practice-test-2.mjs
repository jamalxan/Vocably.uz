    ...
    passages: [
      {
        ...
        paragraphs: [
          {
            label: 'A',
            html: '<p>Long before a photograph could be fixed permanently onto a surface, inventors had understood the basic principle behind the camera: light passing through a small hole projects an inverted image onto the opposite wall of a darkened box. This device, known as the camera obscura, had been used for centuries by artists as a drawing aid. The real breakthrough came in the 1820s, when the French inventor Joseph Nicéphore Niépce succeeded in capturing an image that did not fade when exposed to light. His method required an exposure of roughly eight hours, making it impractical for anything other than perfectly still scenes, but it proved that a permanent photographic record was possible.</p>',
          },
          {
            label: 'B',
            html: '<p>Niépce\'s work was later refined by his business partner, Louis Daguerre, who announced a much faster and sharper process in 1839. The daguerreotype, as it became known, produced a single, highly detailed image on a silvered copper plate. Because there was no negative, each daguerreotype was entirely unique; if a customer wanted a copy, the entire process had to be repeated. Despite this drawback, the daguerreotype\'s remarkable clarity made it hugely popular with portrait studios, which sprang up in every major city within a few years of its introduction.</p>',
          },
          {
            label: 'C',
            html: '<p>A rival approach was developed in England by William Henry Fox Talbot. Rather than fixing an image directly, Talbot\'s calotype process produced a translucent negative, from which any number of positive prints could subsequently be made on paper. Although the resulting prints were initially less sharp than a daguerreotype, the ability to reproduce an image cheaply and repeatedly meant that Talbot\'s negative-positive principle, rather than Daguerre\'s single-plate method, became the foundation of photography for the next century and a half.</p>',
          },
          {
            label: 'D',
            html: '<p>For several decades, photography remained the preserve of professionals and dedicated enthusiasts, largely because it involved coating glass plates with chemicals shortly before each exposure. This changed in 1888, when the American company Kodak introduced a camera pre-loaded with a roll of flexible film, sold under the slogan "You press the button, we do the rest." Customers could take a hundred photographs, then send the entire camera back to the factory for processing. Roll film transformed photography into a mass hobby, since it no longer demanded any specialist chemical knowledge from the person taking the picture.</p>',
          },
          {
            label: 'E',
            html: '<p>The final major shift occurred in the closing decades of the twentieth century, as electronic sensors gradually replaced chemical film. Early digital cameras, built around charge-coupled devices, or CCDs, converted light directly into an electrical signal that could be stored, edited and transmitted without any need for a darkroom. Within about twenty years, digital sensors had become cheap and capable enough to be built into mobile telephones, and the market for traditional film collapsed almost entirely, bringing to a close an era that had begun with Niépce\'s eight-hour exposure.</p>',
          },
        ],
        questionGroups: [
          {
            ...
            instructionHtml:
              'Reading Passage 1 has five paragraphs, A-E. Which paragraph contains the following information? <em>Write the correct letter, A-E.</em>',
            bankReusable: true,
            questions: [
        ...
        questionGroups: [
          {
            ...
            questions: [
              { number: 14, promptHtml: 'Migration behaviour is now completely understood by scientists.', answer: { accepted: ['NO'] }, explanationHtml: 'Paragraph A: several aspects "remain only partly understood".', locatorParagraph: 'A' },
              { number: 15, promptHtml: 'The Arctic tern travels a shorter distance than most other migratory birds.', answer: { accepted: ['NO'] }, explanationHtml: 'Paragraph A describes its migration as "the longest migration known in the animal kingdom".', locatorParagraph: 'A' },
              { number: 16, promptHtml: 'Every migratory species uses exactly the same navigational method.', answer: { accepted: ['NO'] }, explanationHtml: 'Paragraph C: "no single explanation applies to every species".', locatorParagraph: 'C' },
              { number: 17, promptHtml: 'Artificial lighting can create difficulties for birds migrating at night.', answer: { accepted: ['YES'] }, explanationHtml: 'Paragraph D: "artificial light from cities can disorient night-flying birds".', locatorParagraph: 'D' },
              ...
              { number: 19, promptHtml: 'International conservation agreements have had no effect on protecting migratory birds.', answer: { accepted: ['NO'] }, explanationHtml: 'Paragraph E: tracking data "has fed directly into international conservation agreements".', locatorParagraph: 'E' },
            ],
          },
          {
            id: 't2-p2-notes',
      ...
      },
      {
        ...
        paragraphs: [
          { label: 'A', html: '<p>Traditional economic models are built on the assumption that consumers behave rationally, gathering all relevant information and choosing the option that maximises their own benefit. Over the past few decades, however, the field of behavioural economics has shown that real decision-making relies heavily on mental shortcuts, and that these shortcuts can be predictably influenced. Marketers have been quick to apply these findings, embedding subtle psychological techniques into pricing, packaging and advertising.</p>' },
          { label: 'B', html: '<p>One of the best-documented shortcuts is anchoring, in which an initial piece of information disproportionately affects later judgements. A shopper who first sees a jacket priced at three hundred dollars, for example, will judge a subsequent price of one hundred and fifty dollars to be a bargain, even if that second figure is still more than the jacket is actually worth. Retailers exploit this by displaying a high "original" price alongside a discounted one, anchoring the customer\'s expectations before the real price is even revealed.</p>' },
          { label: 'C', html: '<p>A second, closely related principle is loss aversion: people feel the pain of losing something roughly twice as strongly as they feel the pleasure of gaining an equivalent amount. This asymmetry explains the enduring popularity of limited-time offers and phrases such as "only three left in stock", which reframe an ordinary purchase decision as an opportunity to avoid a loss rather than simply to make a gain.</p>' },
          { label: 'D', html: '<p>Social proof is a third widely used technique, based on the observation that people look to the behaviour of others when they are uncertain how to act themselves. Displaying star ratings, customer review counts or a label reading "our best-selling item" all serve to reassure a hesitant buyer that a large number of other people have already made, and presumably not regretted, the same choice.</p>' },
          { label: 'E', html: '<p>A more subtle strategy is the decoy effect, which involves introducing a third option purely to make one of the original two appear more attractive by comparison. A well-known example comes from subscription pricing: a company might offer a cheap digital-only plan, an expensive print-and-digital plan priced almost the same as digital-only, and a print-only plan priced close to the combined option. The print-only plan is rarely chosen, but its presence makes the combined plan look like outstanding value, quietly steering customers towards the more profitable option.</p>' },
          { label: 'F', html: '<p>Not everyone is comfortable with the growing sophistication of these techniques. Supporters describe them as gentle "nudges" that simply make good choices easier without restricting anyone\'s freedom, while critics argue that some applications, particularly those aimed at children or exploiting anxiety about missing out, cross the line from persuasion into manipulation. This disagreement has prompted several countries to consider stricter regulation of online pricing and advertising practices.</p>' },
        ],
        questionGroups: [
          {
            id: 't2-p3-summary',
          ...
          },
          {
            ...
            type: 'matching_information',
            instructionHtml:
              'Reading Passage 3 has six paragraphs, A-F. Which paragraph contains the following information? <em>Write the correct letter, A-F.</em>',
            bankReusable: true,
            questions: [
      ...
      },
      {
        ...
        questionGroups: [
          ...
          },
          {
            ...
            instructionHtml: 'Who will be responsible for each task? <em>Write the correct letter, A or B.</em>',
            bank: [
              { key: 'A', text: 'Priya' },
              { key: 'B', text: 'Jack' },
            ],
