    ...
    passages: [
      {
        ...
        paragraphs: [
          {
            label: 'A',
            html: "<p>Long before chocolate became the sweet treat found in supermarkets around the world, its main ingredient, the cacao tree, grew wild in the tropical rainforests of the Amazon basin in South America, spreading gradually northward over many centuries through trade and migration. <em>Theobroma cacao</em>, as botanists later named it &mdash; a term meaning &ldquo;food of the gods&rdquo; &mdash; produces large pods containing bitter seeds, each pod holding several dozen seeds embedded in a sweet, pulpy substance that early peoples may originally have valued more than the seeds themselves. Archaeological evidence suggests that as early as 1900 BC, the Olmec people of present-day Mexico were already fermenting and roasting these seeds to make a bitter drink, marking the first known use of cacao by humans, and residue analysis of ancient pottery has since confirmed cacao use at sites across the region.</p>",
          },
          {
            label: 'B',
            html: "<p>Several centuries later, the Maya and Aztec civilisations elevated cacao to something far more significant than a simple beverage. Beans were so highly valued that they were used as a form of currency, accepted in Aztec marketplaces for everyday goods and even used to pay tribute to rulers, and a frothy, spiced drink known as <em>xocolatl</em> &mdash; mixed with chilli peppers, cornmeal and other flavourings &mdash; was reserved largely for rulers, warriors and priests. It was consumed during religious ceremonies and believed to carry sacred properties, sometimes offered to gods as part of important rituals, a far cry from the sugary confectionery of today.</p>",
          },
          {
            label: 'C',
            html: "<p>When Spanish conquistadors arrived in the region in the early sixteenth century, they encountered this bitter drink and eventually carried cacao beans back across the Atlantic to Europe, along with the equipment needed to prepare it in the traditional manner. At first, Europeans found the drink unpalatable, bitter and unfamiliar to a palate accustomed to sweeter tastes, but Spanish colonists began adding sugar and vanilla, transforming it into something far more appealing to European tastes. For almost a hundred years, Spain managed to keep the recipe a closely guarded secret, and chocolate remained an expensive luxury enjoyed exclusively by the aristocracy, served in royal courts as a mark of status rather than an everyday refreshment.</p>",
          },
          {
            label: 'D',
            html: "<p>The chocolate familiar to most people today did not appear until the Industrial Revolution, when new machinery finally made large-scale, affordable production possible for the first time. In 1828, a Dutch chemist named Coenraad Van Houten patented a hydraulic press capable of separating cocoa butter from roasted, ground cacao beans, leaving behind a fine powder that could be mixed with liquid far more easily than whole roasted beans ever could. Building on this innovation, Swiss chocolatiers later developed a process called <strong>conching</strong>, which gave chocolate its smooth texture by grinding it for many hours, paving the way for the first solid, edible chocolate bars and, eventually, mass production on a scale the Maya and Aztecs could scarcely have imagined.</p>",
          },
          {
            label: 'E',
            html: "<p>Today, the vast majority of the world&rsquo;s cocoa is grown not in Latin America but in West Africa, with Ivory Coast and Ghana together producing well over half of the global supply, a shift that took place largely over the course of the twentieth century as colonial administrations established plantations in the region. This shift has brought its own difficulties: the industry has faced sustained criticism over poor pay for farmers and the use of child labour on some cocoa farms, issues that have drawn the attention of international labour organisations and consumer advocacy groups alike. In response, certification schemes and direct-trade arrangements between chocolate makers and growers have emerged, aiming to ensure that farmers receive a fairer share of the profits, though campaigners argue that progress on the ground has so far been uneven.</p>",
          },
          {
            label: 'F',
            html: "<p>Chocolate&rsquo;s story is far from finished. Nutrition researchers have identified compounds called <strong>flavonoids</strong> in cocoa, particularly in dark chocolate, that may offer some cardiovascular benefits by supporting healthy blood vessel function, although experts caution that the high sugar content of many chocolate products can easily outweigh any advantage. Meanwhile, agricultural scientists are racing to breed hardier cacao varieties, as rising temperatures and disease threaten to shrink the regions where the crop can be grown, with some projections suggesting that large areas currently used for cacao farming could become unsuitable within a few decades &mdash; a reminder that the future of this ancient food is still being written.</p>",
          },
        ],
        questionGroups: [
          {
      ...
      },
      {
        ...
        paragraphs: [
          { label: 'A', html: "<p>For centuries, scientists studying animal migration relied on direct observation and simple methods such as ringing birds' legs with numbered bands, hoping a bird would later be found or recaptured elsewhere, sometimes years afterwards and thousands of kilometres from where it was originally tagged. This approach offered only an incomplete picture of where animals actually travelled, since it depended entirely on chance encounters rather than continuous observation. Over the past thirty years, satellite and GPS tracking technology has transformed the field, revealing journeys far more detailed and surprising than researchers had imagined, often overturning decades of assumptions built on the earlier, patchier evidence.</p>" },
          { label: 'B', html: "<p>Early tracking devices, developed in the 1960s and 1970s, relied on bulky radio transmitters that had to be physically attached to an animal, often requiring the animal to be captured, sedated and fitted with the equipment by hand. These devices were heavy, expensive and had a limited transmission range, which meant that only larger animals, such as elephants and whales, could realistically carry them without the equipment affecting their behaviour, leaving smaller species almost entirely unstudied by comparison.</p>" },
          { label: 'C', html: "<p>Advances in miniaturisation changed this considerably. Satellite systems such as Argos allowed signals to be picked up from much smaller tags without requiring the animal to be recaptured to retrieve stored data, and today solar-powered GPS tags weighing only a few grams can transmit precise location data for years at a time, recharging themselves during daylight hours much like a small calculator. This has even made it possible to track small songbirds and, remarkably, insects such as monarch butterflies, whose multi-generational migration across North America had previously been reconstructed only indirectly, through the recapture of tagged individuals.</p>" },
          { label: 'D', html: "<p>The findings from this technology have overturned earlier assumptions. Tracking data revealed, for example, that Arctic terns migrate far greater distances than scientists had previously calculated, travelling between the Arctic and the Antarctic each year in a route that, added up over a lifetime, is roughly equivalent to three round trips to the moon. Tracking has also identified previously unknown stopover sites that are critical for resting and feeding, along with threats such as wind farms and hunting located along certain migratory flyways, information that would have been almost impossible to gather through observation alone.</p>" },
          { label: 'E', html: "<p>Citizen science projects, in which members of the public report sightings through smartphone apps, now combine with professional tracking data to build far more comprehensive migration maps than either method could produce alone, effectively multiplying the number of observers gathering data at any one time. These combined datasets have gone on to inform international conservation agreements and the designation of protected migratory corridors, giving policymakers a far more precise picture of exactly which areas most urgently need legal protection.</p>" },
          { label: 'F', html: "<p>Challenges remain, however. The weight and drag of a tag can still affect the behaviour and survival of smaller animals, potentially altering the very migratory patterns researchers are trying to study, and cost and battery life continue to limit how long many species can be tracked. Ethical guidelines have been developed to minimise harm, requiring researchers to justify the likely benefits of a tagging study against any risk to the animals involved, and researchers are now working on lighter, more energy-efficient sensors, including some that transmit data using existing mobile phone networks rather than expensive dedicated satellite links.</p>" },
        ],
        questionGroups: [
          {
            id: 'p2-yng',
            // VOCABLY-TZ.md §2.2 auditi — faktik/tavsifiy passage (kuzatuv
            // texnologiyasi tarixi) uchun YNG emas, TFNG to'g'ri tur (bir xil
            // sabab bilan test-2'dagi "Migratory Birds"ga q.).
            ...
            questions: [
              { number: 14, promptHtml: 'Traditional methods of studying migration gave researchers a complete understanding of animal movements.', answer: { accepted: ['FALSE'] }, explanationHtml: 'Paragraph A says traditional methods offered only "an incomplete picture".', locatorParagraph: 'A' },
              { number: 15, promptHtml: 'Early tracking devices could be attached to almost any species.', answer: { accepted: ['FALSE'] }, explanationHtml: 'Paragraph B says only larger animals could realistically carry early devices.', locatorParagraph: 'B' },
              { number: 16, promptHtml: 'Advances in miniaturisation have made it possible to track insects.', answer: { accepted: ['TRUE'] }, explanationHtml: 'Paragraph C says monarch butterflies can now be tracked.', locatorParagraph: 'C' },
              ...
              { number: 18, promptHtml: 'Tracking data revealed that Arctic terns migrate further than scientists had previously thought.', answer: { accepted: ['TRUE'] }, explanationHtml: 'Paragraph D states Arctic terns migrate "far greater distances than scientists had previously calculated".', locatorParagraph: 'D' },
              { number: 19, promptHtml: 'The weight of tracking devices has no effect on the animals that carry them.', answer: { accepted: ['FALSE'] }, explanationHtml: 'Paragraph F says tag weight and drag can still affect behaviour and survival.', locatorParagraph: 'F' },
            ],
          },
          {
            id: 'p2-summary',
      ...
      },
      {
        ...
        paragraphs: [
          { label: 'A', html: "<p>Not long ago, artificial intelligence, or AI, belonged mostly to science fiction and specialised research laboratories, discussed by the public mainly in terms of distant, hypothetical robots rather than anything encountered in daily life. Today, it is embedded in countless daily routines &mdash; from unlocking a smartphone with facial recognition to receiving a personalised playlist &mdash; often without users being fully aware that AI is involved at all, since the technology is typically designed to work quietly in the background rather than draw attention to itself.</p>" },
          ...
          { label: 'C', html: "<p>Everyday applications now abound. Voice assistants schedule appointments and answer spoken questions; navigation apps predict traffic and suggest faster routes based on real-time data from thousands of other vehicles; streaming services suggest content that users might enjoy; banking systems increasingly use AI for fraud detection, flagging unusual spending patterns within seconds of a transaction; and in medicine, AI can assist with the diagnosis of scans and images, flagging areas that a doctor should examine more closely rather than replacing the doctor's own judgement entirely.</p>" },
          { label: 'D', html: "<p>These benefits come with real concerns. Because models learn from existing data, they can reproduce and even amplify unfair or biased outcomes if that data itself reflects historical bias, sometimes in ways that are difficult to detect until the system has already been deployed at scale. There are also fears about job losses in certain industries, worries about the constant collection of personal data required to train and operate these systems, and calls for greater transparency in high-stakes decisions such as loan approvals or hiring, where an unexplainable AI judgement can feel deeply unfair to the person affected, particularly when no clear explanation for the decision is available.</p>" },
          { label: 'E', html: "<p>In response, governments and international organisations have begun drafting regulations and ethical guidelines intended to balance innovation against these safeguards, with some proposals requiring companies to explain how significant automated decisions are reached. Some technology companies have gone further, establishing internal ethics boards to review how AI systems are designed and used before they are released to the public, though critics question how much independent power such internal boards genuinely hold.</p>" },
          { label: 'F', html: "<p>Looking ahead, AI is expected to become even more deeply integrated into daily life, from autonomous vehicles to personalised education and healthcare diagnostics, gradually taking on tasks that until recently would have seemed to require distinctly human judgement. Many commentators argue that improving public understanding of how these systems work &mdash; sometimes called digital literacy &mdash; will be just as important as any technical advance, since a population that does not understand these tools is poorly placed to hold them to account, as societies continue to debate how much autonomy should ultimately be delegated to machines.</p>" },
        ],
        questionGroups: [
          {
            id: 'p3-flowchart',
